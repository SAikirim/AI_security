...
```
10101010 * 7 + 10101011
10101011(SFD) : Start of Frame Delimiter)
```
* Destination Address : 도착지 MAC 주소 (6바이트)
...
* 2^7 = 128개
    - 다만 0과 127로 시작하는 네트워크는 제외
        + 0.0.0.0/8 : IP 주소를 할당받기 전 임시로 사용하는 주소
        + 127.0.0.0/8 : 자기 자신을 가리키기 위한 목적으로 쓰기 위해 예약된 IP 주소
